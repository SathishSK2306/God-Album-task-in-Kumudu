...
const FRAME_TYPES = [
  {
    ...
    width: 1,
    image:
      "https://static.vecteezy.com/system/resources/previews/024/682/116/non_2x/icon-design-border-frame-free-png.png",
  },
  {
    name: "V Shape",
    width: 2,
    image:
      "https://static.vecteezy.com/system/resources/previews/024/681/935/non_2x/icon-design-border-frame-free-png.png",
  },
  {
    name: "Mani",
    width: 2,
    image:
      "https://static.vecteezy.com/system/resources/previews/024/682/000/non_2x/icon-design-border-frame-free-png.png",
  },
  {
    name: "Aastha Lakshmi",
    width: 3,
    image:
      "https://static.vecteezy.com/system/resources/previews/024/681/931/non_2x/icon-design-border-frame-free-png.png",
  },
  {
    name: "Aastha Lakshmi",
    width: 3,
...
const DimensionSection = ({ selected, onSelect }) => {
  ...
  const { width: frameWidth, height: frameHeight } = parseFrame(
    frameToParse || "42X24"
  );
          ...
          <div className="dimension-layout">
            <div className="dimension-frame-area">
              ...
              <div className="dimension-label-bottom">
                Space for addons
                <br />
                <b>{spaceForAddons} Inches</b>
                <br />
                Work Area Width
                <br />
                <b>{workAreaWidth} Inches</b>
              </div>
            </div>
            {/* Editable Card */}
