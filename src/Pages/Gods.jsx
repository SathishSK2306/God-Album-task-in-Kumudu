...
import god1 from "../assets/ganesha.jpeg";
import god2 from "../assets/lakshmi.jpeg";
import god3 from "../assets/sarasvathi.jpeg";
import god4 from "../assets/tirupati.jpeg";
...
function GodOption({ god }) {
  ...
  return (
    ...
    >
      ...
      />
      <div style={{ fontSize: 15, fontWeight: 600, color: "#22223b" }}>
        {god.name}
      </div>
    </div>
  );
    ...
    >
      {god ? (
        ...
        <>
          ...
          <div
            style={{ fontWeight: 500, fontSize: "1.05rem", color: "#22223b" }}
          >
            Image Area
            <br />8 Inches
          </div>
      ...
      <div style={{ display: "flex" }}>
        ...
        <div style={{ flex: 1 }}>
          <div className="dimension-section">
              ...
              >
                <div className="dimension-frame-area">
                  ...
                  <div className="dimension-label-bottom">
                    Space for Accessories (36 Inches)
                    <br />
                ...
                >
                  <div className="dimension-card-content">
                    ...
                    <div>
                      ...
                      <span className="dimension-card-value">
                        {IMAGE_AREAS}
                      </span>
                    </div>
                    <div>
            ...
            <h4 style={{ margin: "52px 0 0 32px", color: "#22223b" }}>
              Choose God
            </h4>
            <div
              style={{
